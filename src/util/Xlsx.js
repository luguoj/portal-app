...
function make_xlsx_lib(e) {
    ...
    var b = function jl() {
        ...
        return {
            encode: function (r) {
                var t = "";
                var a = 0, n = 0, i = 0, s = 0, l = 0, o = 0, c = 0;
                ...
                var a = "";
                var n = 0, i = 0, s = 0, l = 0, o = 0, c = 0, f = 0;
                t = t.replace(/[^\w\+\/\=]/g, "");
    ...
    var R = function Vl(e) {
        ...
        function A(e, r) {
            switch (typeof e) {
                ...
                case"object":
                    if (e == null) return "";
                    if (e instanceof Date) return B(14, _(e, r && r.date1904), r);
            }
        ...
        var O = function U() {
            ...
            function u(e, r, i) {
                var s = parseInt(e[4], 10), l = Math.round(r * s), o = Math.floor(l / s);
                var c = l - o * s, f = s;
            ...
            function x(e, h, _) {
                ...
                if (A = h.match(/^([#0?]+)\.([#0]+)$/)) {
                    ...
                    E = C.indexOf(".");
                    var R = h.indexOf(".") - E, P = h.length - C.length - R;
            ...
            function A(e, s, l) {
                ...
                if (u = s.match(/^([#0]+)\.([#0]+)$/)) {
                    ...
                    g = c.indexOf(".");
                    var E = s.indexOf(".") - g, F = s.length - c.length - E;
    ...
    var j = function Xl() {
        ...
        function c(e, r) {
            ...
            d(E, F, A);
            A.shift();
            var T = {FileIndex: E, FullPaths: F};
            if (r && r.raw) T.raw = {header: b, sectors: _};
            return T
        }
        ...
        function d(e, r, t) {
            var a = 0, n = 0, i = 0, s = 0, l = 0, o = t.length;
            var c = [], f = [];
            for (; a < o; ++a) {
                c[a] = f[a] = a;
                r[a] = t[a]
        ...
        function g(e, r, t, a) {
            ...
            for (f = 0; f < n; ++f) {
                ...
                i[h] = {nodes: l, data: mr([o])}
            }
            return i
        }

        function k(e, r, t, a, n, i, s, l) {
            var o = 0, c = a.length ? 2 : 0;
            var f = r[e].data;
            var u = 0, h = 0, d;
        ...
        function T(e, n) {
            ...
            for (l = 0; l < u.length; ++l) {
                ...
                if (!s) u.push([h, {name: a(h).replace("/", ""), type: 1, clsid: B, ct: c, mt: c, content: null}])
            }
            u.sort(function (e, t) {
                return r(e[0], t[0])
            });
        ...
        function de(e, r, t) {
            var a = 1, n = 0, i = 0, s = 0, l = 0, o = e.length;
        ...
        function Fe(e, r) {
            ...
            var f = 0, u = 0;
            var h = 0, d = 0;
            var p = e.FullPaths[0], m = p, v = e.FileIndex[0];
            var g = [];
            var b = 0;
    ...
    function Ne(e, r, t) {
        ...
        var s = e.match(Te), l = 0, o = "", c = 0, f = "", u = "", h = 1;
    ...
    if (w) {
        var qe = function Yl(e) {
            var r = Buffer.alloc(2 * e.length), t, a, n = 1, i = 0, s = 0, l;
    ...
    function mt(e) {
        var r = e.indexOf(":");
        if (r == -1) return {s: dt(e), e: dt(e)};
        return {s: dt(e.slice(0, r)), e: dt(e.slice(r + 1))}
    }
    ...
    var It = {
        ...
        4: {n: "ByteCount", t: St},
        5: {n: "LineCount", t: St},
        6: {n: "ParagraphCount", t: St},
        7: {n: "SlideCount", t: St},
        8: {n: "NoteCount", t: St},
        9: {n: "HiddenCount", t: St},
        10: {n: "MultimediaClipCount", t: St},
        11: {n: "ScaleCrop", t: Ct},
        12: {n: "HeadingPairs", t: Mt | At},
        13: {n: "TitlesOfParts", t: Mt | Ft},
        14: {n: "Manager", t: Nt},
        15: {n: "Company", t: Nt},
        16: {n: "LinksUpToDate", t: Ct},
        17: {n: "CharacterCount", t: St},
        19: {n: "SharedDoc", t: Ct},
        22: {n: "HyperlinksChanged", t: Ct},
        23: {n: "AppVersion", t: St, p: "version"},
        24: {n: "DigSig", t: Ot},
    ...
    var Lt = {
        ...
        19: {n: "DocSecurity", t: St},
        255: {}
    };
    var zt = {2147483648: {n: "Locale", t: Et}, 2147483651: {n: "Behavior", t: Et}, 1919054434: {}};
    (function () {
    ...
    var Qt = or("Types", null, {xmlns: ur.CT, "xmlns:xsd": ur.xsd, "xmlns:xsi": ur.xsi});
    ...
    function ra(e, r) {
        ...
        var n = function (n) {
            if (e[n] && e[n].length > 0) {
                ...
                t[t.length] = or("Override", null, {
                    PartName: (a[0] == "/" ? "" : "/") + a,
                    ContentType: Jt[n][r.bookType || "xlsx"]
                })
            }
        };
        var i = function (a) {
        ...
        var s = function (r) {
            (e[r] || []).forEach(function (e) {
                t[t.length] = or("Override", null, {PartName: (e[0] == "/" ? "" : "/") + e, ContentType: qt[r][0]})
            })
        };
        n("workbooks");
        i("sheets");
    ...
    var ia = or("Relationships", null, {xmlns: ur.RELS});
    ...
    function pa(e, r) {
        ...
        if (e) {
            if (e.CreatedDate != null) da("dcterms:created", typeof e.CreatedDate === "string" ? e.CreatedDate : cr(e.CreatedDate, t.WTF), {"xsi:type": "dcterms:W3CDTF"}, a, n);
            if (e.ModifiedDate != null) da("dcterms:modified", typeof e.ModifiedDate === "string" ? e.ModifiedDate : cr(e.ModifiedDate, t.WTF), {"xsi:type": "dcterms:W3CDTF"}, a, n)
        }
    ...
    var wa = or("Properties", null, {xmlns: ur.EXT_PROPS, "xmlns:vt": ur.vt});
    ...
    var _a = or("Properties", null, {xmlns: ur.CUST_PROPS, "xmlns:vt": ur.vt});
    ...
    var Ca = function () {
        ...
        function c(e, a) {
            ...
            var i = Zr();
            var s = Ml(e, {header: 1, raw: true, cellDates: true});
            var c = s[0], f = s.slice(1);
            var u = 0, h = 0, d = 0, p = 1;
        ...
        return {versions: a, to_workbook: s, to_sheet: i, from_sheet: c}
    }();
    var Aa = function () {
        var e = {
            AA: "À",
        ...
        return {to_workbook: l, to_sheet: s, from_sheet: h}
    }();
    var Ea = function () {
        function e(e, t) {
            switch (t.type) {
    ...
    var Ta = function () {
        function e(e, r, t, a, n) {
            ...
            } else if (!isNaN(he(e))) r[t][a] = he(e); else if (!isNaN(de(e).getDate())) r[t][a] = oe(e); else r[t][a] = e
        }
        ...
        function i(e, r) {
            ...
            var l = 0, o = 0, c = 0;
            var f = 0, u = 0, h = a.charCodeAt(0), d = false, p = 0;
            e = e.replace(/\r\n/gm, "\n");
        ...
        function l(e, r) {
            var t = "", a = r.type == "string" ? [0, 0, 0, 0] : ul(e, r);
            switch (r.type) {
                case"base64":
                    t = b.decode(e);
                    break;
    ...
    function ja(e, r) {
        if (!r.bookSST) return "";
        var t = [Fe];
        t[t.length] = or("sst", null, {xmlns: ur.main[0], count: e.Count, uniqueCount: e.Unique});
        for (var a = 0; a != e.length; ++a) {
        ...
        for (n = 0; n < i.length; ++n) {
            ...
            switch (Re(s[0])) {
                ...
                case"<numFmts>":
                    break;
                case"<numFmt": {
                    var l = Le(Ye(s.formatCode)), o = parseInt(s.numFmtId, 10);
                    r.NumberFmt[o] = l;
                    if (o > 0) {
                        if (o > 392) {
    ...
    var yn = or("styleSheet", null, {xmlns: ur.main[0], "xmlns:vt": ur.vt});
    ...
    function zn(e, r) {
        ...
        var n = [or("xml", null, {
            ...
            "v:ext": "edit",
            data: e
        }), {"v:ext": "edit"}), or("v:shapetype", [or("v:stroke", null, {joinstyle: "miter"}), or("v:path", null, {
            gradientshapeok: "t",
            "o:connecttype": "rect"
        ...
        r.forEach(function (e) {
            ...
            var a = t.type == "gradient" ? or("o:fill", null, {type: "gradientUnscaled", "v:ext": "view"}) : null;
            var i = or("v:fill", a, t);
    ...
    var $n = or("comments", null, {xmlns: ur.main[0]});
    ...
    var Kn = function () {
        ...
        function t(e, t, a, n) {
            ...
            var l = a.length > 0 ? parseInt(a, 10) | 0 : 0, o = n.length > 0 ? parseInt(n, 10) | 0 : 0;
            if (i) o += r.c; else --o;
            if (s) l += r.r; else --l;
    ...
    function Ii(e, r, t, a) {
        ...
        if (l == i.length) i.push({Name: "_xlnm._FilterDatabase", Sheet: a, Ref: "'" + t.SheetNames[a] + "'!" + n});
    ...
    var $i = function () {
        ...
        return function l(o, c, f, u, h, d) {
            var p = 0, m = "", v = [], g = [], b = 0, w = 0, k = 0, y = "", x;
            var _, S = 0, C = 0;
            var A, E;
            var F = 0, T = 0;
            var O = Array.isArray(d.CellXf), D;
            var M = [];
            var R = [];
    ...
    function Ui(e, r, t, a) {
        var n = [], i = [], s = gt(e["!ref"]), l = "", o, c = "", f = [], u = 0, h = 0, d = e["!rows"];
    ...
    var ji = or("worksheet", null, {xmlns: ur.main[0], "xmlns:r": ur.r});
    ...
    function Hi(e, r, t, a) {
        ...
        var u = [];
        Ai(o, t, e, r, n);
        n[n.length] = or("dimension", null, {ref: c});
        ...
        if (u.length > 0) {
            ...
            n[n.length] = or("drawing", null, {"r:id": "rId" + p});
            o["!drawing"] = u
        }
        if (o["!comments"].length > 0) {
            p = oa(a, -1, "../drawings/vmlDrawing" + (e + 1) + ".vml", ta.VML);
            n[n.length] = or("legacyDrawing", null, {"r:id": "rId" + p});
            o["!legacy"] = p
        }
        if (n.length > 1) {
    ...
    var Gi = or("chartsheet", null, {xmlns: ur.main[0], "xmlns:r": ur.r});
    ...
    var ds = or("workbook", null, {xmlns: ur.main[0], "xmlns:r": ur.r});
        ...
        function e(e, r) {
            ...
            for (s = 0; s < o.length; ++s) {
                ...
                for (l = 0; l < b.length; ++l) {
                    ...
                    } else if (k === "TRUE") A = {t: "b", v: true}; else if (k === "FALSE") A = {
                        t: "b",
                        v: false
                    }; else if (!isNaN(he(k))) A = {t: "n", v: he(k)}; else if (!isNaN(de(k).getDate())) {
                        A = {t: "d", v: oe(k)};
        ...
        for (; p < l.length && m < o; ++p) {
            ...
            for (g = b = 0; g < x.length; ++g) {
                ...
                if ((w = +_.getAttribute("rowspan") || 1) > 1 || k > 1) u.push({
                    s: {r: m + n, c: b + i},
                    e: {r: m + n + (w || 1) - 1, c: b + i + (k || 1) - 1}
                });
                var E = {t: "s", v: S};
                var F = _.getAttribute("t") || "";
                if (S != null) {
                    if (S.length == 0) E.t = F || "z"; else if (a.raw || S.trim().length == 0 || F == "s") {
                    } else if (S === "TRUE") E = {t: "b", v: true}; else if (S === "FALSE") E = {
                        t: "b",
                        v: false
                    }; else if (!isNaN(he(S))) E = {t: "n", v: he(S)}; else if (!isNaN(de(S).getDate())) {
                        E = {t: "d", v: oe(S)};
                        if (!a.cellDates) E = {t: "n", v: ee(E.v)};
    ...
    var zs = function () {
        ...
        return function t(a, n) {
            ...
            var x = "", _ = 0, S;
            var C = [];
            var A = -1, E = -1, F = {s: {r: 1e6, c: 1e7}, e: {r: 0, c: 0}};
            var T = 0;
            var O = {};
            var D = [], M = {}, N = 0, R = 0;
            var P = [], I = 1, L = 1;
            ...
            while (w = xlmlregex.exec(s)) switch (w[3] = w[3].replace(/_.*$/, "")) {
                ...
                case"行":
                    ...
                    if (I < 10) for (Y = 0; Y < I; ++Y) if (T > 0) P[A + Y] = {level: T};
                    E = -1;
                    break;
                ...
                case"数据":
                    if (w[0].charAt(w[0].length - 2) === "/") {
                        ...
                        U = [];
                        j = {};
                        k = {t: y["数据类型"] || y["value-type"], v: null};
                        if (i.cellFormula) {
                            ...
                            if (!(i.sheetRows && i.sheetRows <= A)) {
                                for (var q = 0; q < I; ++q) {
                                    ...
                                    if (i.dense) {
                                        ...
                                        b[pt({r: A + q, c: E})] = k;
                                        while (--L > 0) b[pt({r: A + q, c: E + L})] = fe(k)
                                    }
                                    if (F.e.c <= E) F.e.c = E
                                }
                            }
            ...
            var re = {Sheets: m, SheetNames: g, Workbook: B};
    ...
    var Us = function () {
        var e = function (e) {
            return We(e).replace(/  +/g, function (e) {
        ...
        var a = function (a, n, i) {
            ...
            for (; l <= c.e.r; ++l) {
                ...
                for (; o <= c.e.c; ++o) {
                    ...
                    var v = pt({r: l, c: o}), g = h ? (a[l] || [])[o] : a[v];
                    if (g && g.f) {
    ...
    function wl(e, r) {
        c();
        if (typeof ArrayBuffer !== "undefined" && e instanceof ArrayBuffer) return wl(new Uint8Array(e), r);
    ...
    function Sl(e, r, t) {
        ...
        switch (r.type) {
            ...
            case"buffer": {
                if (w) return k(a, "utf8"); else return Sl(a, {type: "binary"}).split("").map(function (e) {
    ...
    function Dl(e, r, t, a, n, i, s, l) {
        var o = it(t);
        var c = l.defval, f = l.raw || !Object.prototype.hasOwnProperty.call(l, "raw");
        var u = true;
        var h = n === 1 ? [] : {};
        if (n !== 1) {
    ...
    function zl(e, r, t) {
        ...
        var p = it(s);
        if (n) for (d = 0; d < h.length; ++d) i[ct(d + l) + p] = {t: "s", v: h[d]};
        i["!ref"] = vt(f);
        return i
    }
