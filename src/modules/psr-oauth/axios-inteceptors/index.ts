...
function useAuthorizationHeader(config: AxiosRequestConfig, context: PSROAuthContext<TokenService>) {
...
export function usePSROAuthInterceptor(client: AxiosInstance, context: PSROAuthContext<TokenService>) {
